...
export default function Hero() {
  return (
    <section className="grid-container bg-gray-200 " id="Home">
      <main className="col-start-2 col-end-2   flex flex-col md:flex-row md:justify-between pt-20 md:mx-20  ">
        <div className="font-semibold md:mt-20    ">
          <h1 className=" mb-1 md:mb-8 md:-ml-2 md:tracking-widest text-5xl md:text-8xl ">
            NEW
          </h1>
          <h2 className=" mb-10 text-3xl md:tracking-widest md:text-5xl">
            ARRIVALS
          </h2>
